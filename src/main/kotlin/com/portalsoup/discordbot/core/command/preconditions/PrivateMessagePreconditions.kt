...
@CommandDsl
class PrivateMessagePreconditions <E : GenericPrivateMessageEvent>(val preconditions: MutableList<(E) -> Boolean>) {
...
@CommandDsl
class PrivateMessageAuthorPreconditions<E: GenericPrivateMessageEvent>(val preconditions: MutableList<(E) -> Boolean>) {
